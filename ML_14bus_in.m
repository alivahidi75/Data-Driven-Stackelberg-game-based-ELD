...
%% 
load('stackelberg_optimal_points_variable_costs_dataset.mat'); 
...
%% 
LMP1_true = Y_test_real(1,:)';
LMP1_pred = Y_pred(1,:)';

P1_true = round(Y_test_real(2,:)',5);
P1_pred = round(Y_pred(2,:)',5);

P3_true = Y_test_real(3,:)';
P3_pred = Y_pred(3,:)';

P4_true = Y_test_real(4,:)';
P4_pred = Y_pred(4,:)';

P5_true = Y_test_real(5,:)';
P5_pred = Y_pred(5,:)';
...
%% 
figure;
sgtitle('Time-Series Plots: Actual vs. Predicted Values (Test Data)');
